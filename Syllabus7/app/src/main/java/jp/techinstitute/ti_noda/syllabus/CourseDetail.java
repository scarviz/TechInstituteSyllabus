...
public class CourseDetail extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 「supportTeacher」という名前(キー)をつけた文字列を取り出す
		String supportTeacherStr = intent.getStringExtra("supportTeacher");
		...
		// 「supportTeacherText」というIDをつけたTextView
		TextView supportTeacherText = (TextView)findViewById(R.id.supportTeacherText);
		supportTeacherText.setText(supportTeacherStr);
	}
